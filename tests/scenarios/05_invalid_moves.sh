...
expect_err_code OUT_OF_BOUNDS ttt inv-o action move "$game_id" а5 --game-token "$o_token"
expect_err_code OUT_OF_BOUNDS ttt inv-o action move "$game_id" d1 --game-token "$o_token"
